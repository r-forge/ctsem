...
output<-ctSummaryMatrices(object=object,ridging=ridging,timeInterval=timeInterval)
 
  output$omxsummary<-omxSummary(object=object)
...
ctSummaryMatrices<-function(object,ridging,timeInterval){
